  ...
  return (
      <div className="footer">
        ...
        <div className="footer-services">
          ...
          <ul>
            <li>
              <a href="/services/hostels">
                {language === "az" ? "Qonaqlama" : "Hostels"}
              </a>
            </li>
            <li>
              <a href="/services/kitchen">
        ...
        <div className="footer-news">
          ...
          <ul>
            <li>
              <a href="/blogs">{language === "az" ? "Bloqlar" : "Blogs"}</a>
            </li>
          </ul>
        </div>
        <div className="footer-support">
          ...
          <ul>
            ...
            <li>
              <a href="#contact">{language === "az" ? "Əlaqə" : "Contact"}</a>
            </li>
            <li>
              <a href="/contract">
                {language === "az"
                  ? "Qaydalar & Şərtlər və Məxfilik siyasəti"
        ...
        <div className="footer-links">
          ...
          <ul>
            <li>
              <a href="https://www.facebook.com/ecorest.az/">
