...
function Main() {
  ...
  useEffect(() => {
    ...
    const queryParam = searchQuery
      ...
      : "";
    fetch(
      `https://ecorest-az.preview-domain.com/backend/get_best_places.php${queryParam}`
    )
        ...
        <div className="main-search">
          ...
          <ul>
            <Link to={"/services/"}>
              <li>
                ...
                <button
                  onClick={() =>
                    handleClick(language === "az" ? "Axtar?" : "Search?")
                  }
            ...
            <Link to={"/services/hostels"}>
              <li>
                ...
                <button
                  onClick={() =>
                    handleClick(
                      language === "az" ? "Harda qalmaq olar?" : "Where to stay?"
                    )
                  }
                  data-hover={
                    language === "az" ? "Harda qalmaq olar?" : "Where to stay?"
              ...
              <li>
                ...
                <button
                  onClick={() =>
                    handleClick(
                      language === "az"
                        ? "Milli yeməkləri kəşf et?"
                        : "Discover national dishes?"
                    )
                  }
                  data-hover={
                    language === "az"
            ...
            <Link to={"/services/events/"}>
              <li>
                ...
                <button
                  onClick={() =>
                    handleClick(language === "az" ? "Həftəsonu?" : "Weekend?")
                  }
            ...
            <Link to={"/services/organicpro/"}>
              ...
              <i class="fa-solid fa-mountain-sun"></i>
                <button
                  onClick={() =>
                    handleClick(language === "az" ? "Sağlam ol" : "Be healthy")
                  }
          ...
          <div className="search">
            ...
            <input
              ...
              name="search"
              id="search"
              placeholder={language === "az" ? "Gedilməli yerlər,  işlər və s." : "Places to go, things to do and etc."}
              value={searchQuery}
        ...
        <div className="news-banner">
          {newsList.map((news_banner, index) => (
            <div
              ...
              key={index}
              onClick={() =>
                handleBannerClick(news_banner.id, news_banner.service_type)
              }
            >
              {" "}
              <img
                src={`https://ecorest.az/backend/${news_banner.image_url}`}
                alt={news_banner.product_name}
              />
