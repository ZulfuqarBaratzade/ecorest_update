    ...
    <div className="App">
      ...
      <LanguageProvider>
        ...
        <Routes>
          ...
          <Route path="/services/kitchen/:id" element={<Service_detail />} />
          <Route path="/services/hostels/:id" element={<Service_detail />} />
          <Route path="/services/organicpro/:id" element={<Service_detail />} />
          <Route path="/services/events/:id" element={<Service_detail />} />
